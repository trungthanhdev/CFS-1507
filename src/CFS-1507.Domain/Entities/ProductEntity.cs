...
namespace CFS_1507.Domain.Entities
{
    public class ProductEntity : TEntityClass
    {
        ...
        private ProductEntity(string product_name, double? product_price, string? product_description, string? product_image)
        {
        ...
        public static ProductEntity Create(string product_name, double? product_price, string? product_description, string? product_image)
        {
            return new ProductEntity(product_name, product_price, product_description, product_image);
        }
        public void Update(string? product_name, string? product_image, string? product_description, double? product_price)
        {
